...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\user\\Documents\\MRnGO_psychopy_experiment\\MRnGO_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    train_outer_loop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('concept_lists/demo.csv'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    # completed 1.0 repeats of 'train_outer_loop'
