...
function outer_csv_selectorRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of outer_csv_selectorComponents)
...
function start_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function library_checkRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of library_checkComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function library_entryRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of library_entryComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function library_seenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of library_seenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function rules_start_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of rules_start_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function rules_01_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of rules_01_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function rules_02_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of rules_02_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_start_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_start_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function train_outer_loopLoopBegin(train_outer_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrain_outer_loop of train_outer_loop) {
...
function main_outer_loopLoopBegin(main_outer_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisMain_outer_loop of main_outer_loop) {
...
function csv_selectorRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of csv_selectorComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function train_maskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of train_maskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function train_stimulus_presentationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of train_stimulus_presentationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function train_yesno_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of train_yesno_responseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function train_written_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of train_written_responseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_start_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_start_screenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function csv_selector_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of csv_selector_mainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_fixationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_fixationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_maskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_maskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_stimulus_presentationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_stimulus_presentationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_yesno_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_yesno_responseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function binoc_findRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of binoc_findComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
